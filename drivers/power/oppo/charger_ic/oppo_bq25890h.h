...
int bq25890h_charging_current_set(struct oppo_chg_chip *chip);
int bq25890h_input_current_limit_set(struct oppo_chg_chip *chip);
...
extern int mt_get_chargerid_volt (struct oppo_chg_chip *chip);

//#ifdef CONFIG_MTK_HAFG_20
extern void mt_set_chargerid_switch_val(struct oppo_chg_chip *chip, int value);
extern int mt_get_chargerid_switch_val(struct oppo_chg_chip *chip);
extern void mt_set_usb_shell_ctrl_val(struct oppo_chg_chip *chip, int value);
extern int mt_get_usb_shell_ctrl_val(struct oppo_chg_chip *chip);
